...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Proyecciones y transformaciones basicas_Erandi", nullptr, nullptr);
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		ourShader.Use();
		glm::mat4 model=glm::mat4(1); //el elemento que queremos modelar
		glm::mat4 view=glm::mat4(1); // el elemento que se visualizara
		...
		//no descomentes la linea de abajo si no ya no funciona 
		...
		//cubo3
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.14f, -0.8f,-1.0f)); 
		model = glm::rotate(model, 0.5f, glm::vec3(1.0f, 1.0f, 0.0f)); 
		...
		//cubo4
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.70f, -0.57f, -1.47f)); 
		...
		//cubo5
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.4f, -0.1f, 0.3f)); 
		...
		//cubo6
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.3f, 0.36f, -0.15f));
		model = glm::rotate(model, glm::radians(190.0f), glm::vec3(1.0f, 0.0f, 0.0f));
